  ...
  return `
        <div class="px-4 py-6 sm:px-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-32 max-w-6xl mx-auto">
            ...
            ${
              client.plano !== "Nenhum"
                ? `
                <div class="bg-surface-section/30 p-6 rounded-[2rem] space-y-4">
                    <div class="flex justify-between items-center px-2">
                        <div class="flex items-center gap-3">
                            <i class="fas fa-crown text-brand-primary text-xs"></i>
                            <h4 class="text-[10px] font-black text-white uppercase tracking-widest">Informações do Plano ${client.plano}</h4>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-surface-page/50 p-4 rounded-xl flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <h4 class="font-black text-white">${client.plano_pagamento ? new Date(client.plano_pagamento + "T00:00:00").toLocaleDateString("pt-BR") : "PENDENTE"}</h4>
                            </div>
                        </div>
