...
export const RecordRow = (record) => {
  ...
  return `
        <div class="flex flex-col md:grid md:grid-cols-[70px_1.5fr_1.2fr_1fr_100px_130px_100px] md:gap-4 items-center px-6 py-4 md:py-3 hover:bg-surface-subtle transition-colors group relative glass-card md:bg-transparent rounded-2xl md:rounded-none m-2 md:m-0 border-none ${isBreak ? "bg-surface-subtle" : ""}" style="z-index: 1;" onfocusin="this.style.zIndex = '100'" onfocusout="this.style.zIndex = '1'">
