...
export const MobileNav = () => `
    <nav class="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-surface-section/95 backdrop-blur-xl border-t border-transparent flex items-center justify-around px-4 z-40 pb-safe">
